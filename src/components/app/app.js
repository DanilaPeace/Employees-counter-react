...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      employeesData: [
        ...
        { name: "Max P.", bonus: false, salary: 500, rise: false, id: 4 },
      ],
      searchString: "",
      filter: "all",
    };
  ...
  bonusCounter = () =>
    this.state.employeesData.filter((employee) => employee.bonus).length;
    ...
    switch (filter) {
      ...
      case "moreThen1000":
        return employeesArr.filter(
          (employee) => employee.salary >= MIN_SALARY_VALUE
        );
      default:
        return employeesArr;
    }
